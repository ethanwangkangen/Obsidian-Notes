...
# Socket
- Sockets are identified by **all 4** of the following
	- Sender IP
	- Sender Port
	- Receiver IP
	- Receiver Port
- TCP demultiplcxes incoming segments using **all 4 values** 
	- **Cannot** determine which process gets and incoming segment by looking at destination port number only
