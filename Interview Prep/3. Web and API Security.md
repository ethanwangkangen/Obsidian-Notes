...
- Accessing files outside intended directory by using dot-slash sequences
	- `file=../../../../etc/passwd`
- LFI: Local file inclusion
	- Trick application into loading unintended local files
